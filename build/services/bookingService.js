...
var _require = require("uuid"),
  uuidv4 = _require.v4;
var URL = function URL(doctorId, token) {
  var result = "";
  result = "".concat(process.env.URL_REACT, "/verify-booking?token=").concat(token, "&doctorId=").concat(doctorId);
  return result;
};
var PatientBooking = function PatientBooking(data) {
  return new Promise(/*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      var dataDoctor, token, user;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            if (!(!data.email || !data.doctorId || !data.date || !data.timeType || !data.userName)) {
              _context.next = 5;
              break;
            }
            resolve({
          ...
          case 7:
            ...
            return _emailService["default"].sendEmail({
              ...
              price: data.language === "vi" ? dataDoctor.priceTypeData.valueVi + " VND" : dataDoctor.priceTypeData.valueEn + " USD",
...
var PatientBooked = function PatientBooked(data) {
  return new Promise(/*#__PURE__*/function () {
